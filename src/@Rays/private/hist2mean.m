function histmat  = hist2mean( x, y, weights, xedges, yedges )
% function histmat  = hist2mean(x, y,weights, xedges, yedges)
%
% Extract 2D histogram data containing the mean of numbers of events
...
%instead of adding up histogram count, create average

if ~isempty( weights )
    hstres =  weights( ind );
end

hstres = hstres-mean(hstres);
clear xy;
